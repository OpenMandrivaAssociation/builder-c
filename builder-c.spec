...
Source0:	https://github.com/DuratarskeyK/builder-c/archive/%{version}.zip
...
%build
%{__cc} %{optflags} -lconfig -lcurl -pthread jsmn.c statistics.c live_inspector.c live_logger.c exec_build.c api.c main.c -o builder
